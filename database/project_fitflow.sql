...
CREATE TABLE `cc_payments` (
  ...
  `response_desc` text COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `modules` (`id`, `name_en`, `name_ar`, `status`, `slug`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE `notifications` (
  ...
  `message` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `message_ar` text COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `registered_users` (
  ...
  `civilid` text COLLATE utf8_unicode_ci DEFAULT NULL,
...
(1, 'Fitflow', '2020-04-11 07:36:06', '2020-04-11 07:36:06');
...
CREATE TABLE `vendors` (
  ...
  `commission` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `profile_image` text COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `vendor_branches` (
  ...
  `office_time` text COLLATE utf8_unicode_ci DEFAULT NULL,
