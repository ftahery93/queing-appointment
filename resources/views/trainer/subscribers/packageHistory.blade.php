...
jQuery(document).ready(function ($) {
    ...
    $table4.DataTable({
        ...
        "ajax": {
            "type": "GET",
            url: "{{ url('trainer')}}/"+ID + '/packageHistory',
            complete: function () {
                $('.loading-image').hide();
            }
        },
        columns: [
            ...
            {data: 4, name: 'num_points', class: 'text-center', orderable: false},
            {data: 5, name: 'num_days', class: 'text-center', orderable: false},
            {data: 7, name: 'action', class: 'text-center', orderable: false}
        ],
        order: [[3, 'desc']],
           "fnDrawCallback": function (oSettings) {
                                ...
                                $('.package_details').on('click', function (e) {
                                    ...
                                    $.ajax({
                                        type: "GET",
                                        async: true,
                                        url: "{{ url('trainer')}}/"+payment_id + '/packagePayment',
