...
Workers
@endsection
<form class="form" role="form" method="POST" action="{{ url('trainer/users/delete')  }}" >  
    {{ csrf_field() }} 
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        ...
                        <a href="{{ url('trainer/users/create')  }}" class="margin-top0">
