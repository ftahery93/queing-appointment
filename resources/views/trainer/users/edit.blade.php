...
Users
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"   action="{{ url('trainer/users/'. $User->id)  }}" method="POST" id="form1">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" readonly id="name" autocomplete="off" value="{{ $User->name }}" name="name">
                                    @if ($errors->has('name'))
                            ...
                            <div class="col-sm-6{{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" class="form-control" readonly id="email" autocomplete="off" value="{{ $User->email }}" name="email"> 
                                    @if ($errors->has('email'))
                                    <span class="help-block">
                            ...
                            <div class="col-sm-6{{ $errors->has('branch_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <select name="branch_id" class="select2" data-allow-clear="true" >
                                        ...
                                        <option value="{{ $branch->id }}" @if($User->branch_id == $branch->id) selected  @endif >{{ $branch->name_en }}</option>
                                        @endforeach
                                    </select>
