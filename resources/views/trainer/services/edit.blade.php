...
<li>
    ...
    <a href="{{ url('trainer/service') }}">service</a>
</li>
@endsection
...
Service
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"   action="{{ url('/trainer/services/'. $Service->id)  }}" method="POST" id="form1" enctype="multipart/form-data">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options padding10">
                        ...
                        <a href="{{ url('trainer/service') }}" class="margin-top0">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('name_en') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name_en" autocomplete="off" value="{{ $Service->name_en }}" name="name_en">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-9">
                                    <select name="isQueue" class="select2" data-allow-clear="true" id="isQueue" >
                                        <option value="1" @if($Service->isQueue == 1) selected  @endif> Yes</option>
                                        <option value="0" @if($Service->isQueue == 0) selected  @endif> No</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-9">
                                    <select name="isAppointment" class="select2" data-allow-clear="true" id="isAppointment" >
                                        <option value="1" @if($Service->isAppointment == 1) selected  @endif> Yes</option>
                                        <option value="0" @if($Service->isAppointment == 0) selected  @endif> No</option>
                                    </select>
                                </div>
                            </div>
