        ...
        <div class="panel panel-dark" data-collapsed="0">   
            ...
            <div class="row margin10">
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <label for="member_status" class="col-sm-4 control-label">Subscriber Status</label>
                                ...
                                jQuery(document).ready(function ($) {
                                    ...
                                    $table4.DataTable({
                                        ...
                                        columns: [
                                            ...
                                            {data: 5, name: 'num_points', class: 'text-center', orderable: false, searchable: false},
                                            {data: 6, name: 'count_class', class: 'text-center', orderable: false, searchable: false},
...
<script>
    ...
    function ConfirmPrint() {
        window.location.href = '{{ url("trainer/printSubscriptions") }}';
    }

    /*------END----*/

    function excelExport() {
        window.location.href = '{{ url("trainer/excelSubscriptions") }}';
    }
</script> 
@endsection