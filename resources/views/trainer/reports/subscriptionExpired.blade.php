...
<script type="text/javascript">
                                jQuery(document).ready(function ($) {
                                    ...
                                    $table4.DataTable({
                                        ...
                                        "ajax": {
                                            "type": "GET",
                                            "url": '{{ url("trainer/subscriptionExpired") }}',
                                            data: function (data) {
...
<script>
    ...
    function ConfirmPrint() {
        window.location.href = '{{ url("trainer/printSubscriptionExpired") }}';
    }

    /*------END----*/

    function excelExport() {
        window.location.href = '{{ url("trainer/excelSubscriptionExpired") }}';
    }
</script> 
@endsection