                                ...
                                jQuery(document).ready(function ($) {
                                    ...
                                    $table4.DataTable({
                                        ...
                                        columns: [
                                            ...
                                            {data: 2, name: 'reference_id',orderable: false, searchable: false, class: 'text-center'},
...
<script>
    ...
    function ConfirmPrint() {
        window.location.href = '{{ url("trainer/printPayments") }}';
    }

    /*------END----*/

    function excelExport() {
        window.location.href = '{{ url("trainer/excelPayments") }}';
    }
</script> 
@endsection