...
<li>
    ...
    <a href="{{ url('trainer/packages') }}">Packages</a>
</li>
@endsection
...
Packages
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"   action="{{ url('/trainer/packages/'. $TrainerPackage->id)  }}" method="POST" id="form1" enctype="multipart/form-data">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options padding10">
                        ...
                        <a href="{{ url('trainer/packages') }}" class="margin-top0">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('name_en') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name_en" autocomplete="off" value="{{ $TrainerPackage->name_en }}" name="name_en">
                            ...
                            <div class="col-sm-6{{ $errors->has('name_ar') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name_ar" autocomplete="off" value="{{ $TrainerPackage->name_ar }}" name="name_ar" dir="rtl">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('num_points') ? ' has-error' : '' }}"  id="num_class">
                                ...
                                <label for="num_points" class="col-sm-3 control-label">No. of Points</label>

                                <div class="col-sm-5">
                                    <input type="tel" class="form-control" id="num_points" autocomplete="off"  name="num_points" value="{{ $TrainerPackage->num_points }}"  @if($TrainerPackage->num_points == 0) readonly  @endif>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input tabindex="5" type="checkbox" class="icheck-14 col-sm-4" id="minimal-checkbox-1-14"  @if($TrainerPackage->num_points == 0) checked  @endif>
                            ...
                            <div class="col-sm-6{{ $errors->has('price') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="form-control" id="price" autocomplete="off"  name="price" value="{{ $TrainerPackage->price }}"> 
                                    @if ($errors->has('price'))
                                    <span class="help-block">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-9">
                                    <select name="status" class="select2" data-allow-clear="true" id="status" >
                                        <option value="1" @if($TrainerPackage->status == 1) selected  @endif> Active</option>
                                        <option value="0" @if($TrainerPackage->status == 0) selected  @endif> Deactive</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6{{ $errors->has('num_days') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="form-control" id="num_days" autocomplete="off"  value="{{ $TrainerPackage->num_days }}" name="num_days">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <div class="col-sm-6{{ $errors->has('description_en') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <textarea  class="form-control resize" name="description_en" id="description_en" >{{ $TrainerPackage->description_en }}</textarea>
                            ...
                            <div class="col-sm-6{{ $errors->has('description_ar') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <textarea  class="form-control resize" name="description_ar" id="description_ar" dir="rtl">{{ $TrainerPackage->description_ar }}</textarea>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('expired_notify_duration') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="form-control" id="expired_notify_duration" autocomplete="off"  value="{{ $TrainerPackage->expired_notify_duration }}" name="expired_notify_duration">
                            ...
                            <div class="col-sm-6">
                                   ...
                                   <div class="col-sm-9">
                                    <input tabindex="5" type="checkbox" class="icheck-14 col-sm-4" id="offer" 
                                     @if($TrainerPackage->has_offer == 1) checked  @endif>
                                     <input type="hidden" name="has_offer" id="has_offer" value="{{ $TrainerPackage->has_offer }}" >
                                </div>
                                </div>
