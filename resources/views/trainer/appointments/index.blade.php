...
Appointment
@endsection
<form class="form" role="form" method="POST" action="{{ url('trainer/appointments/delete')  }}" >  
    {{ csrf_field() }} 
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        ...
                        <a href="{{ url('trainer/appointments/create')  }}" class="margin-top0">
                    ...
                    <table class="table table-bordered datatable" id="table-4">
                        <thead>
                            <tr>
                                ...
                                <th class="col-sm-1">Slot1</th>
                                <th class="col-sm-1">Slot2</th>
                                <th class="col-sm-1">Time Interval</th>
                                <th class="text-center col-sm-2">Person</th>
                            ...
                            jQuery(document).ready(function ($) {
                                ...
                                $table4.DataTable({
                                    ...
                                    columns: [
                                        ...
                                        {data: 3, name: 'slot1', class: 'text-center'},
                                        {data: 4, name: 'slot2', class: 'text-center'},
                                        {data: 5, name: 'time_interval', orderable: false, searchable: false, class: 'text-center'},
                                        {data: 6, name: 'num_persons', class: 'text-center'},
...
// Removed the checked state from "All" if any checkbox is unchecked
                                        ...
                                        $('.status').on('click', function (e) {
                                            ...
                                            $.ajax({
                                                type: "PATCH",
                                                async: true,
                                                url: "{{ url('trainer/appointments')}}/"+ID,
