            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('working_hours') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="working_hours" autocomplete="off"  value="{{ $TrainerPackage->working_hours }}" name="working_hours">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <div class="col-sm-6{{ $errors->has('address') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <textarea  class="form-control resize" name="address" id="address" >{{ $TrainerPackage->address }}</textarea>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-9">
                      <input type="text" class="form-control" id="latitude" autocomplete="off" value="{{ $TrainerPackage->latitude }}" name="latitude">
                      ...
                      <div class="col-sm-9">
                      <input type="text" class="form-control" id="longitude" autocomplete="off" value="{{ $TrainerPackage->longitude }}" name="longitude">
