...
Branches
@endsection
<form class="form" role="form" method="POST" action="{{ url('trainer/branches/delete')  }}" >  
    {{ csrf_field() }} 
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        ...
                        <a href="{{ url('trainer/branches/create')  }}" class="margin-top0">
                    ...
                    <table class="table table-bordered datatable" id="table-4">
                        <thead>
                            <tr>
                                ...
                                <th class="col-sm-2">Working Hours</th>
                            ...
                            jQuery(document).ready(function ($) {
                                ...
                                $table4.DataTable({
                                    ...
                                    columns: [
                                        ...
                                        {data: 1, name: 'name_en'},
                                        {data: 2, name: 'latitude', class: 'text-center'},
                                        {data: 3, name: 'longitude', class: 'text-center'},
                                        {data: 4, name: 'working_hours', class: 'text-center'},
