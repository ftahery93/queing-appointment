...
General Notifications
@endsection
<form class="form" role="form" method="POST" action="{{ url('admin/notifications/delete')  }}" >  
    {{ csrf_field() }} 
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        @if ($CreateAccess==1)
                        <a href="{{ url('admin/notifications/create')  }}" class="margin-top0">
                           ...
                           jQuery(document).ready(function ($) {
                               ...
                               $table4.DataTable({
                                   ...
                                   columns: [
                                       ...
                                       {data: 1, name: 'send_to', class: 'text-center', searchable: false},
