...
<li>
    ...
    <a href="{{ url('admin/notifications')  }}">General Notifications</a>
</li>
@endsection
...
General Notifications
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"  method="POST" action="{{ url('/admin/notifications') }}" id="form1" enctype="multipart/form-data">
    {{ method_field('POST') }}
    {{ csrf_field() }}
...
<!--                            <div class="col-sm-6{{ $errors->has('link') ? ' has-error' : '' }}">
                               ...
                               <div class="col-sm-6{{ $errors->has('send_to') ? ' has-error' : '' }}">
                                <label for="send_to" class="col-sm-3 control-label">Send To</label>
                                <div class="col-sm-9">
                                    <select name="send_to" class="select2" data-allow-clear="true" >           
                                        <option value="">--Select--</option>
                                        <option value="0" {{ (collect(old('send_to'))->contains(0)) ? 'selected':'' }} >All Application Users</option>
                                        <option value="1" {{ (collect(old('send_to'))->contains(1)) ? 'selected':'' }} >Registered Users</option>
                                        <option value="2" {{ (collect(old('send_to'))->contains(3)) ? 'selected':'' }} >Non-Register Users</option>                               
                                    </select>
