...
{{ ucfirst($vendorName->name) }} - Transactions
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"   action="{{ url('/admin/vendortransactions/'. $Transaction->id)  }}" method="POST" id="form1" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('amount') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="amount" class="form-control number_only" id="amount" autocomplete="off" value="{{ $Transaction->amount }}" name="amount"> 
