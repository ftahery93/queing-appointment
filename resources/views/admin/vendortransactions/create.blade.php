...
@section('title')
{{ ucfirst($vendorName->name) }} - Transactions
@endsection
...
<li>
    ...
    <a href="{{ url('admin').'/'.$vendor_id.'/vendortransactions' }}">Transactions</a>
</li>
@endsection
...
{{ ucfirst($vendorName->name) }} - Transactions
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"  method="POST" action="{{ url('/admin/vendortransactions').'/'.$vendor_id.'/store' }}" id="form1" enctype="multipart/form-data">
    {{ method_field('POST') }}
    {{ csrf_field() }}
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options padding10">
                        ...
                        <a href="{{ url('admin').'/'.$vendor_id.'/vendortransactions' }}" class="margin-top0">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('reference_num') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="form-control" id="reference_num" autocomplete="off" value="{{ old('reference_num') }}" name="reference_num"> 
                            ...
                            <div class="col-sm-6{{ $errors->has('amount') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="amount" class="form-control number_only" id="amount" autocomplete="off" value="{{ old('amount') }}" name="amount"> 
                            ...
                            <div class="col-sm-6{{ $errors->has('payment_mode') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <select name="payment_mode" class="select2" data-allow-clear="true" >
                                        ...
                                        <option value="{{ $paymentMode->id }}" {{ (collect(old('payment_mode'))->contains($paymentMode->id)) ? 'selected':'' }} >{{ $paymentMode->name_en }}</option>
                                        @endforeach
                                    </select>
