...
{{ ucfirst($vendorName->name) }} -  Transactions
@endsection
<form class="form" role="form" method="POST" action="{{ url('admin/vendortransactions/delete')  }}" >  
    {{ csrf_field() }} 
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        @if ($CreateAccess==1)
                        <a href="{{ url('admin/vendortransactions').'/'.$vendor_id.'/create'  }}" class="margin-top0">
...
<script type="text/javascript">
                            jQuery(document).ready(function ($) {
                                ...
                                $table4.DataTable({
                                    ...
                                    "ajax": {
                                        "type": "GET",
                                        "url": '{{ url("admin/$vendor_id/vendortransactions") }}',
                                        complete: function () {
                                            $('.loading-image').hide();
                                        }
                                    },
...
// Removed the checked state from "All" if any checkbox is unchecked
                                        ...
                                        $('.status').on('click', function (e) {
                                            ...
                                            $.ajax({
                                                type: "PATCH",
                                                async: true,
                                                url: "{{ url('admin/vendortransactions')}}/"+ID,
                                        ...
                                        $('.transactionEmail').on('click', function (e) {
                                            ...
                                            $.ajax({
                                                type: "GET",
                                                async: true,
                                                url: "{{ url('admin/vendortransactions')}}/"+ID + '/transactionEmail',
                                                data: {id: ID},
                                                success: function (data) {
                                                    $table4.DataTable().ajax.reload(null, false);
                                                    toastr.success(data.response, "", opts);
