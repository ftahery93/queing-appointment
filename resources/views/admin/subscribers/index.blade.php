...
@section('title')
Trainer {{ ucfirst($trainerName->name) }} - Subscribers
@endsection
        ...
        <div class="panel panel-default" data-collapsed="0">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <ul class="nav nav-tabs bordered"><!-- available classes "bordered", "right-aligned" -->
                    <li class="active">
                        <a href="{{ url('admin').'/'.$trainer_id.'/subscribers'  }}" >
                            <span class="visible-xs"><i class="entypo-home"></i></span>
                            <span class="hidden-xs">Active</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('admin').'/'.$trainer_id.'/archivedSubscribers'  }}" >
...
<script type="text/javascript">
                    jQuery(document).ready(function ($) {
                        ...
                        $table4.DataTable({
                            ...
                            "ajax": {
                                "type": "GET",
                                "url": '{{ url("admin/$trainer_id/subscribers") }}',
                                data: function (data) {
                                    data.id = $('#log').val();
                                },
                                complete: function () {
                            ...
                            "fnDrawCallback": function (oSettings) {
                                ...
                                $('.current_package').on('click', function (e) {
                                    ...
                                    $.ajax({
                                        type: "GET",
                                        async: true,
                                        url: "{{ url('admin/subscribers/')}}/" + ID + '/currentPackage',
                                ...
                                $('.payment_details').on('click', function (e) {
                                    ...
                                    $.ajax({
                                        type: "GET",
                                        async: true,
                                        url: "{{ url('admin/subscribers/')}}/" + ID + '/paymentDetails',
                                        success: function (data) {
                                            $('#current_package').html(data.html);
                                        },
                                        complete: function () {
