...
<li>
    ...
    <a href="{{ url('admin').'/'.$trainer_id.'/subscribers'  }}">Subscribed</a>
</li>
<li>

    <a href="{{ url('admin').'/'.$trainer_id.'/archivedSubscribers'  }}">Archived</a>
</li>
@endsection
...
jQuery(document).ready(function ($) {
    ...
    $table4.DataTable({
        ...
        "ajax": {
            "type": "GET",
            url: "{{ url('admin')}}/"+ID + '/packageHistory',
            complete: function () {
                $('.loading-image').hide();
            }
        },
           ...
           "fnDrawCallback": function (oSettings) {
                                ...
                                $('.package_details').on('click', function (e) {
                                    ...
                                    $.ajax({
                                        type: "GET",
                                        async: true,
                                        url: "{{ url('admin')}}/"+payment_id + '/packagePayment',
