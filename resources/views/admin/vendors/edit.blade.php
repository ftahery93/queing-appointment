...
Vendors
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"   action="{{ url('/admin/vendors/'. $Vendor->id)  }}" method="POST" id="form1" enctype="multipart/form-data">
                            ...
                            <div class="panel panel-primary" data-collapsed="0">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-12">
                                            ...
                                            <div class="col-sm-6{{ $errors->has('name') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="name" autocomplete="off" value="{{ $Vendor->name }}" name="name">
                                                    @if ($errors->has('name'))
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-12">
                                            ...
                                            <div class="col-sm-6{{ $errors->has('mobile') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="tel" class="form-control number_only" id="mobile" autocomplete="off" value="{{ $Vendor->mobile }}" name="mobile">
                                            ...
                                            <div class="col-sm-6{{ $errors->has('email') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="email" class="form-control" id="email" autocomplete="off" value="{{ $Vendor->email }}" name="email"> 
                                                    @if ($errors->has('email'))
                                                    <span class="help-block">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-12">
                                            <div class="col-sm-6{{ $errors->has('modules') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="modules[]" class="select2" data-allow-clear="true" multiple="multiple" >
                                                        ...
                                                        <option value="{{ $module->id }}" @if ($collection->contains($module->id)) selected  @endif >{{ $module->name_en }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-sm-6{{ $errors->has('username') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="username" autocomplete="off"  value="{{ $Vendor->username }}" name="username">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-12">
                                            ...
                                            <div class="col-sm-6{{ $errors->has('code') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="tel" class="form-control" id="code" autocomplete="off"  value="{{ $Vendor->code }}" name="code">
                                                    @if ($errors->has('code'))
                                                    <span class="help-block">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="status" class="select2" data-allow-clear="true" id="status" >
                                                        ...
                                                        <option value="0" @if($Vendor->status == 0) selected  @endif> Deactive</option>
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <?php /* ?>
                                      ...
                                      <div class="col-sm-8">
                                      <input type="tel" class="form-control" id="civilid" autocomplete="off"  value="{{ $Vendor->civilid }}" name="civilid">
                                                    ...
                                                    <div class="well">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12  margin-btm10">
                                                                <label for="m{{ $module->id }}" class="col-sm-9 control-label" style="font-size:11px;">{{ ucfirst($module->name_en) }} (%)</label>
                                                                <div class="col-sm-3">
                                                                    <input type="text" class="form-control number_only" id="m{{ $module->id }}" autocomplete="off" name="commission[{{ $module->id }}]"
                                                                           value="{{ $commission[$module->id] }}" >
                                                                </div>
                                     ...
                                     <div class="row">
                                        <div class="form-group col-sm-12" >
                                            ...
                                            <div class="col-sm-12"  id="uploaded_image_estore">
                                                ...
                                                <label for="estore_image" class="col-sm-2 control-label">Uploaded {{ $modules->last()->name_en }} Image</label>
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="col-sm-12{{ $errors->has('bank_id') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-12">
                                                <select name="bank_id" class="select2" data-allow-clear="true"  >
                                                    ...
                                                    <option value="{{ $bank->id }}" @if ($bank->id==$Vendor->bank_id)) selected  @endif >{{ $bank->name_en }}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="row margin-btm10">
                                        <div class="col-sm-12{{ $errors->has('acc_name') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="acc_name" autocomplete="off" value="{{ $Vendor->acc_name }}" name="acc_name">
                                    ...
                                    <div class="row margin-btm10">
                                        <div class="col-sm-12{{ $errors->has('acc_num') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="acc_num" autocomplete="off" value="{{ $Vendor->acc_num }}" name="acc_num">
                                    ...
                                    <div class="row margin-btm10">
                                        <div class="col-sm-12{{ $errors->has('ibn_num') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="ibn_num" autocomplete="off" value="{{ $Vendor->ibn_num }}" name="ibn_num">
                                ...
                                <div class="panel-body">
                                    <div class="row margin-btm10">
                                        <div class="col-sm-12{{ $errors->has('contract_name') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="contract_name" autocomplete="off" value="{{ $Vendor->contract_name }}" name="contract_name">
                                    ...
                                    <div class="row margin-btm10">
                                        <div class="col-sm-12{{ $errors->has('contract_startdate') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="contract_startdate" autocomplete="off" value="{{ $Vendor->contract_startdate }}" name="contract_startdate">
                                    ...
                                    <div class="row margin-btm10">
                                        <div class="col-sm-12{{ $errors->has('contract_enddate') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="contract_enddate" autocomplete="off" value="{{ $Vendor->contract_enddate }}" name="contract_enddate">
                                ...
                                <div class="panel-body">
                                    <div class="row margin-btm10">
                                        <div class="col-sm-12{{ $errors->has('delivery_charge') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control number_only" id="delivery_charge" autocomplete="off" value="{{ $Vendor->delivery_charge }}" name="delivery_charge">
