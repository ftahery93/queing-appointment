...
Vendors
@endsection
<form class="form" role="form" method="POST" action="{{ url('admin/vendors/delete')  }}" >  
    {{ csrf_field() }} 
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        @if ($CreateAccess==1)
                        <a href="{{ url('admin/vendors/create')  }}" class="margin-top0">
                        ...
                        <a href="{{ url('admin/vendors/trashedlist')  }}" class="margin-top0">
