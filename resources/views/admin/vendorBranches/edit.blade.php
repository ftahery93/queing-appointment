...
@section('title')
{{ ucfirst($vendorName->name) }} - Branches
@endsection
...
<li>
    ...
    <a href="{{ url('/admin').'/'.$vendor_id.'/vendorBranches' }}">Branches</a>
</li>
@endsection
...
{{ ucfirst($vendorName->name) }} - Branches
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"   action="{{ url('admin/vendorBranches/'. $VendorBranch->id)  }}" method="POST" id="form1" enctype="multipart/form-data" name="form1">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options padding10">
                        ...
                        <a href="{{ url('/admin').'/'.$vendor_id.'/vendorBranches' }}" class="margin-top0">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="form-group col-sm-12">
                             ...
                             * <div class="col-sm-6{{ $errors->has('vendor_id') ? ' has-error' : '' }}">
                              ...
                              <option value="{{ $vendor->id }}" @if ($VendorBranch->vendor_id==$vendor->id) selected  @endif >{{ $vendor->name }}</option>
                              @endforeach
                              </select>
                            ...
                            <div class="col-sm-6{{ $errors->has('gender_type') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <select name="gender_type[]" class="select2" data-allow-clear="true" multiple="multiple" onchange="GetSelectedTextValue(this.value)">

                                        @foreach ($gender_types as $gender_type)
                                        <option value="{{ $gender_type->id }}" @if ($collection->contains($gender_type->id)) selected  @endif >{{ $gender_type->name_en }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-6{{ $errors->has('contact') ? ' has-error' : '' }}" style="margin-top:10px;">
                                ...
                                <div class="col-sm-9 after-add-more">
                                    <input type="text" name="contact" class="form-control" autocomplete="off" value="{{ $VendorBranch->contact }}">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('name_en') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name_en" autocomplete="off" value="{{ $VendorBranch->name_en }}" name="name_en">
                            ...
                            <div class="col-sm-6{{ $errors->has('name_ar') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name_ar" autocomplete="off" value="{{ $VendorBranch->name_ar }}" name="name_ar"> 
                     ...
                     *               <div class="row">
                      ...
                      <div class="col-sm-9">
                      <input type="text" class="form-control" id="contact_person_en" autocomplete="off" value="{{ $VendorBranch->contact_person_en }}" name="contact_person_en">
                      ...
                      <div class="col-sm-9">
                      <input type="text" class="form-control" id="contact_person_ar" autocomplete="off" value="{{ $VendorBranch->contact_person_ar }}" name="contact_person_ar">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('area') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <select name="area" class="select2" data-allow-clear="true">
                                        ...
                                        <option value="{{ $area->id }}" @if ($VendorBranch->area==$area->id) selected  @endif >{{ $area->name_en }}</option>
                                        @endforeach
                                    </select>
                                    @if ($errors->has('area'))
                                    <span class="help-block">
                            ...
                            <div class="col-sm-6{{ $errors->has('amenities') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <select name="amenities[]" class="select2" data-allow-clear="true" multiple="multiple">
                                        @foreach ($amenities as $amenity)
                                        <option value="{{ $amenity->id }}" @if ($amenityCollection->contains($amenity->id)) selected  @endif >{{ $amenity->name_en }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-group col-sm-12">
                            <div class="col-sm-6">
                                <div class="col12">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control datetimepicker" id="shift1_time1" autocomplete="off"  name="shifting_hours[shift1][start]"
                                               value="@if ($shifting_hours['shift1']['start']!='') {{ $shifting_hours['shift1']['start'] }}  @endif" @if($shifting_hours['fullshift']['time']== 1) readonly @endif >                                   
                                    </div>
                                    <div class="col-sm-4 pull-right">
                                        <input type="text" class="form-control datetimepicker" id="shift1_time2" autocomplete="off"  name="shifting_hours[shift1][end]" 
                                               value="@if ($shifting_hours['shift1']['end']!='') {{ $shifting_hours['shift1']['end'] }}  @endif" @if($shifting_hours['fullshift']['time']== 1) readonly @endif >                              
                                    </div>
                                </div>
                                ...
                                <div class="col12">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control datetimepicker" id="shift2_time1" autocomplete="off"  name="shifting_hours[shift2][start]" 
                                               value="@if ($shifting_hours['shift2']['start']!='') {{ $shifting_hours['shift2']['start'] }} @endif" @if($shifting_hours['fullshift']['time']== 1) readonly @endif >                                    
                                    </div>
                                    <div class="col-sm-4 pull-right">
                                        <input type="text" class="form-control datetimepicker" id="shift2_time2" autocomplete="off"  name="shifting_hours[shift2][end]"
                                               value="@if ($shifting_hours['shift2']['end']!='') {{ $shifting_hours['shift2']['end'] }} @endif" @if($shifting_hours['fullshift']['time']== 1) readonly @endif   >                                   
                                    </div>
                                </div>
                                <div class="col12">
                                    <label for="minimal-checkbox-1-14" class="col-sm-3 control-label">24 Hours</label>
                                    <div class="col-sm-4">
                                        <input tabindex="5" type="checkbox" class="icheck-14 col-sm-4" id="minimal-checkbox-1-14" value="1" @if($shifting_hours['fullshift']['time']== 1) checked @endif >                                   
                                               <input type="hidden" value="{{  $shifting_hours['fullshift']['time'] }}" name="shifting_hours[fullshift][time]" id="fullshift" />
                                    </div>
                                    <div class="col-sm-4 pull-right">                                                                     
                                    </div>
                                </div>
                                 ...
                                 <div class="col12">
                                    ...
                                    <div class="col-sm-2">
                                        <input tabindex="5" type="checkbox" class="icheck-14 col-sm-4" id="minimal-checkbox-1-14" value="1" @if($VendorBranch->is_main_branch == 1) checked @endif name="main_branch_id"
                                        @if($VendorBranch->id == $branchID->id) disabled  @endif>
                                    </div>
                                    <div class="col-sm-5">  
                                      @if($VendorBranch->id == $branchID->id)
                                   <span style="color:red;"> {{ config('global.defaultBranch') }}  </span>   
                                   @endif                                                            
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6{{ $errors->has('address') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <textarea  class="form-control resize" name="address" id="address" >{{ $VendorBranch->address }}</textarea>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-9">
                                    <select name="status" class="select2" data-allow-clear="true" id="status" >
                                        <option value="1" @if($VendorBranch->status == 1) selected  @endif> Active</option>
                                        <option value="0" @if($VendorBranch->status == 0) selected  @endif> Deactive</option>
                                    </select>
                                </div>
                            </div> 
                        </div>
                        ...
                        <div class="form-group col-sm-12">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-11">
                                    ...
                                    <input type="button" value="Search"  onClick="showAddress(this.value);
                                            ga('send', 'event', 'form', 'submit', 'address');
                                            return false"  class="btn btn-primary col-sm-2"/>
                     ...
                     *               <div class="row">                       
                      ...
                      <label for="contact" class="col-sm-3 control-label">Contact No.</label>
                      <div class="col-sm-9 after-add-more">
                      @foreach ($collection as $contact_val)
                      <div class="row clone_add"  style="margin-bottom:10px">
                      <div class="col-sm-7">
                      <input type="text" name="contact[]" class="form-control" autocomplete="off" value="{{ $contact_val }}">
                      </div>
                      <div class="col-sm-5">
...
<script>
    function load() {
        ...
        if (GBrowserIsCompatible()) {
            ...
            var center = new GLatLng('{{ $VendorBranch->latitude }}', '{{ $VendorBranch->longitude }}');
