...
{{ ucfirst($vendorName->name) }} - Branches
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"  method="POST" action="{{ url('/admin/vendorBranches').'/'.$vendor_id.'/store' }}" id="form1" enctype="multipart/form-data" name="form1">
    {{ method_field('POST') }}
    {{ csrf_field() }}
