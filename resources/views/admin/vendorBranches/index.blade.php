...
{{ ucfirst($vendorName->name) }} - Branches
@endsection
<form class="form" role="form" method="POST" action="{{ url('admin/vendorBranches').'/'.$vendor_id.'/delete'  }}" >  
    {{ csrf_field() }} 
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        @if ($CreateAccess==1)
                        <a href="{{ url('admin/vendorBranches').'/'.$vendor_id.'/create'  }}" class="margin-top0">
...
<script type="text/javascript">
                            ...
                            dom: 'lBfrtip',
                                    ...
                                    "type": "GET",
                                            @if ($vendor_id != 0)
                                            "url":  '{{ url("admin/$vendor_id/vendorBranches") }}',
                                            @else
                                            "url":  '{{ url("admin/vendorBranches") }}',
                                            @endif
                                            complete: function () {
                                            $('.loading-image').hide();
                                            }
                                    ...
                                    {data: 1, name: 'name_en'},
                                    {data: 2, name: 'contact', orderable: false, class: 'text-center'},
                                    {data: 3, name: 'area'},
                                    {data: 4, name: 'status', orderable: false, searchable: false, class: 'text-center'},
...
// Removed the checked state from "All" if any checkbox is unchecked
                                    ...
                                    type: "PATCH",
                                            async: true,
                                            url: "{{ url('admin/vendorBranches')}}/"+ID,
