...
Faq
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"   action="{{ url('/admin/faq/'. $Faq->id)  }}" method="POST" id="form1" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('question_en') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="question_en" autocomplete="off" value="{{ $Faq->question_en }}" name="question_en">
                            ...
                            <div class="col-sm-6{{ $errors->has('question_ar') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="question_ar" autocomplete="off" value="{{ $Faq->question_ar }}" name="question_ar" dir="rtl">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <div class="col-sm-6{{ $errors->has('answer_en') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <textarea  class="form-control resize" name="answer_en" id="answer_en" >{{ $Faq->answer_en }}</textarea>
                            ...
                            <div class="col-sm-6{{ $errors->has('answer_ar') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <textarea  class="form-control resize" name="answer_ar" id="answer_ar"  dir="rtl">{{ $Faq->answer_ar }}</textarea>
