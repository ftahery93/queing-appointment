...
Faq 
@endsection
<form class="form" role="form" method="POST" action="{{ url('admin/faq/delete')  }}" >  
    {{ csrf_field() }} 
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        @if ($CreateAccess==1)
                        <a href="{{ url('admin/faq/create')  }}" class="margin-top0">
...
<script type="text/javascript">
                            ...
                            dom: 'lBfrtip',
                                    ...
                                    {data: 1, name: 'question_en'},
                                    {data: 2, name: 'answer_en'},
