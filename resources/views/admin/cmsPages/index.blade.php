...
CMS Pages
@endsection
<form class="form" role="form" method="POST" action="{{ url('admin/cmsPages/delete')  }}" >  
    {{ csrf_field() }} 
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        @if ($CreateAccess==1)
<!--                        <a href="{{ url('admin/cmsPages/create')  }}" class="margin-top0">
