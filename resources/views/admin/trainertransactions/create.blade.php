...
{{ ucfirst($trainerName->name) }} - Transactions
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"  method="POST" action="{{ url('/admin/trainertransactions').'/'.$trainer_id.'/store' }}" id="form1" enctype="multipart/form-data">
    {{ method_field('POST') }}
    {{ csrf_field() }}
