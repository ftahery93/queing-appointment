...
{{ $appTitle->title }} Packages
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"   action="{{ url('/admin/packages/'. $Package->id)  }}" method="POST" id="form1" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('name_en') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name_en" autocomplete="off" value="{{ $Package->name_en }}" name="name_en">
                            ...
                            <div class="col-sm-6{{ $errors->has('name_ar') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name_ar" autocomplete="off" value="{{ $Package->name_ar }}" name="name_ar">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('num_points') ? ' has-error' : '' }}"  id="num_class">
                                ...
                                <div class="col-sm-5">
                                    <input @if($Package->num_points == 0) type="hidden" else type="tel"  @endif class="form-control" id="num_points" autocomplete="off"  name="num_points" value="{{ $Package->num_points }}" >
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input tabindex="5" type="checkbox" class="icheck-14 col-sm-4" id="minimal-checkbox-1-14"  @if($Package->num_points == 0) checked  @endif>
                            ...
                            <div class="col-sm-6{{ $errors->has('price') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="form-control" id="price" autocomplete="off"  name="price" value="{{ $Package->price }}"> 
                                    @if ($errors->has('price'))
                                    <span class="help-block">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('num_days') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="form-control" id="num_days" autocomplete="off"  value="{{ $Package->num_days }}" name="num_days">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <div class="col-sm-6{{ $errors->has('description_en') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <textarea  class="form-control resize" name="description_en" id="description_en" >{{ $Package->description_en }}</textarea>
                            ...
                            <div class="col-sm-6{{ $errors->has('description_ar') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <textarea  class="form-control resize" name="description_ar" id="description_ar" >{{ $Package->description_ar }}</textarea>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('expired_notify_duration') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="form-control" id="expired_notify_duration" autocomplete="off"  value="{{ $Package->expired_notify_duration }}" name="expired_notify_duration">
                             ...
                             <div class="col-sm-6">
                                   ...
                                   <div class="col-sm-9">
                                    <input tabindex="5" type="checkbox" class="icheck-14 col-sm-4" id="offer" 
                                     @if($Package->has_offer == 1) checked  @endif>
                                     <input type="hidden" name="has_offer" id="has_offer" value="{{ $Package->has_offer }}" >
                                </div>
                                </div>
