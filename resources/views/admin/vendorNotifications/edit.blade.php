...
<li>
    ...
    <a href="{{ url('admin/vendorNotifications')  }}">Vendor Notifications</a>
</li>
@endsection
...
Vendor Notifications
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"   action="{{ url('/admin/vendorNotifications/'. $Notification->id)  }}" method="POST" id="form1" enctype="multipart/form-data">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options padding10">
                        ...
                        <a href="{{ url('admin/vendorNotifications')  }}" class="margin-top0">
                            ...
                            <div class="col-sm-6{{ $errors->has('vendor_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <select name="vendor_id" class="select2" data-allow-clear="true" id="vendor_id" onchange="GetSelectedTextValue()" >
                                        ...
                                        <option value="{{ $Vendor->id }}"  @if($Notification->vendor_id==$Vendor->id) selected  @endif> {{ $Vendor->name }}</option>
                                        @endforeach
                                    </select>
