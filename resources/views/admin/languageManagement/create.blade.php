...
Language Management
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"  method="POST" action="{{ url('/admin/languageManagement') }}" id="form1" enctype="multipart/form-data">
    {{ method_field('POST') }}
    {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('label_en') ? ' has-error' : '' }}">
                                <label for="label_en" class="col-sm-3 control-label">Label(EN)</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="label_en" autocomplete="off" value="{{ old('label_en') }}" name="label_en">
                            ...
                            <div class="col-sm-6{{ $errors->has('label_ar') ? ' has-error' : '' }}">
                                <label for="label_ar" class="col-sm-3 control-label">Label(AR)</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="label_ar" autocomplete="off" value="{{ old('label_ar') }}" name="label_ar" dir="rtl">
