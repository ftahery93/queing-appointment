...
<script type="text/javascript">
                                jQuery(document).ready(function ($) {
                                    ...
                                    $table4.DataTable({
                                        ...
                                        "ajax": {
                                            "type": "GET",
                                            "url": '{{ url("admin/orderReport/customerOrders") }}',
                                            data: function (data) {
                                        ...
                                        columns: [
                                            ...
                                            {data: 3, name: 'email', class: 'text-center', orderable: false},
                                            {data: 4, name: 'mobile', class: 'text-center', orderable: false},
                                            {data: 5, name: 'num_orders', class: 'text-center', orderable: false, searchable: false},
                                            {data: 6, name: 'total', class: 'text-right', orderable: false},
                                            {data: 7, name: 'action', class: 'text-center', orderable: false, searchable: false},
                                        ],
                                        order: [[0, 'DESC']],                                        
...
<script>
    ...
    function ConfirmPrint() {
        window.location.href = '{{ url("admin/orderReportPrint/customerOrders") }}';
    }

    /*------END----*/

    function excelExport() {
        window.location.href = '{{ url("admin/excelModule4CustomerOrders") }}';
    }
</script> 
@endsection