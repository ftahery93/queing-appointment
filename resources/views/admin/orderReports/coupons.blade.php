                ...
                <table class="table table-bordered datatable" id="table-4">
                    <thead>
                        <tr>
                            ...
                            <th class="col-sm-6">Coupon Name</th>
...
<script type="text/javascript">
                                jQuery(document).ready(function ($) {
                                    ...
                                    $table4.DataTable({
                                        ...
                                        "ajax": {
                                            "type": "GET",
                                            "url": '{{ url("admin/orderReport/coupons") }}',
                                            data: function (data) {
                                        ...
                                        columns: [
                                            {data: 0, name: 'vendor'},
                                            {data: 1, name: 'coupon_name'},
                                            {data: 2, name: 'code', class: 'text-center', orderable: false},
                                            {data: 3, name: 'num_orders', class: 'text-center', orderable: false, searchable: false},
...
<script>
    ...
    function ConfirmPrint() {
        window.location.href = '{{ url("admin/orderReportPrint/coupons") }}';
    }

    /*------END----*/

    function excelExport() {
        window.location.href = '{{ url("admin/excelModule4Coupons") }}';
    }
</script> 
@endsection