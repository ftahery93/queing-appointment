                        ...
                        <table class="table table-bordered ">
                            ...
                            jQuery(document).ready(function ($) {
                                ...
                                $table4.DataTable({
                                    ...
                                    "ajax": {
                                        "type": "GET",
                                        "url": '{{ url("admin/orderReport/orderPayments") }}',
                                        data: function (data) {
                                    ...
                                    "drawCallback": function (settings) {
                                        ...
                                        //do whatever  
                                                                                                                        ...
                                                                                                                        <script>
                                                                                                                            ...
                                                                                                                            function ConfirmPrint() {
                                                                                                                                window.location.href = '{{ url("admin/orderReportPrint/orderPayments") }}';
                                                                                                                            }

                                                                                                                            /*------END----*/

                                                                                                                            function excelExport() {
                                                                                                                                window.location.href = '{{ url("admin/excelModule4OrderPayments") }}';
                                                                                                                            }
                                                                                                                        </script> 
                                                                                                                        @endsection