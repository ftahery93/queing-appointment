...
Registered Users
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off" method="POST"
    action="{{ url('/admin/registeredUsers') }}" id="form1" enctype="multipart/form-data">
    {{ method_field('POST') }}
    {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('mobile') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="form-control number_only" id="mobile" autocomplete="off"
                            ...
                            <div class="col-sm-6{{ $errors->has('dob') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control datetimepicker" id="dob" autocomplete="off"
                                ...
                                <div class="col-sm-9">
                                    <select name="area_id" class="select2" data-allow-clear="true">
                                        ...
                                        <option value="{{ $area->id }}"
                                            {{ (collect(old('area_id'))->contains($area->id)) ? 'selected':'' }}>
                                            {{ $area->name_en }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-sm-9">
                                    <select name="gender_id" class="select2" data-allow-clear="true">
                                        ...
                                        <option value="{{ $gender->id }}"
                                            {{ (collect(old('gender_id'))->contains($gender->id)) ? 'selected':'' }}>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-9">
                                    <select name="status" class="select2" data-allow-clear="true" id="status">
                                        <option value="1" {{ (collect(old('status'))->contains(1)) ? 'selected':'' }}>
                                            Active</option>
                                        <option value="0" {{ (collect(old('status'))->contains(0)) ? 'selected':'' }}>
                                            Deactive</option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;"
                                            data-trigger="fileinpu                                t">
                                            <img src="{{ asset('assets/images/album-image-1.jpg') }}"
                                                alt=".                                                                                                                                                  ..">
                                        </div>
