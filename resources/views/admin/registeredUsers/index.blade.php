...
Registered Users
@endsection
<form class="form" role="form" method="POST" action="{{ url('admin/registeredUsers/delete')  }}" >  
    {{ csrf_field() }} 
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        @if ($CreateAccess==1)
                        <a href="{{ url('admin/registeredUsers/create')  }}" class="margin-top0">
                        ...
                        <a href="{{ url('admin/registeredUsers/trashedlist')  }}" class="margin-top0">
...
<script type="text/javascript">
                            ...
                            dom: 'lBfrtip',
                                    ...
                                    {data: 4, name: 'dob', class: 'text-center'},
...
// Removed the checked state from "All" if any checkbox is unchecked
                                    ...
                                    type: "PATCH",
                                            async: true,
                                            url: "{{ url('admin/registeredUsers')}}/" + ID,
