...
Amenities
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"   action="{{ url('/admin/amenities/'. $Amenity->id)  }}" method="POST" id="form1" enctype="multipart/form-data">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options padding10">
                        ...
                        <a href="{{ url('admin/amenities') }}" class="margin-top0">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('name_en') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name_en" autocomplete="off" value="{{ $Amenity->name_en }}" name="name_en">
                            ...
                            <div class="col-sm-6{{ $errors->has('name_ar') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name_ar" autocomplete="off" value="{{ $Amenity->name_ar }}" name="name_ar">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-9">
                                    <select name="status" class="select2" data-allow-clear="true" id="status" >
                                        <option value="1" @if($Amenity->status == 1) selected  @endif > Active</option>
                                        <option value="0" @if($Amenity->status == 0) selected  @endif > Deactive</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6" @if($Amenity->icon != '' || $Amenity->icon!=null) style="display:none;" @endif id="upload_image">
                            ...
                            <div class="col-sm-6"  id="uploaded_image">
                                ...
                                <div class="col-sm-9">
                                    <img src="{{ url('public/amenities_icons/'.$Amenity->icon) }}" alt="Uploaded Icon" style="{{ $activity_icon_WH }}">
