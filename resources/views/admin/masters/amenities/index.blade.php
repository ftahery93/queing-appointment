...
Amenities
@endsection
<form class="form" role="form" method="POST" action="{{ url('admin/masters/amenities/delete')  }}" >  
    {{ csrf_field() }} 
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        @if ($CreateAccess==1)
                        <a href="{{ url('admin/amenities/create')  }}" class="margin-top0">
                    ...
                    <table class="table table-bordered datatable" id="table-4">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center col-sm-3">Icon</th>
                            ...
                            jQuery(document).ready(function ($) {
                                ...
                                $table4.DataTable({
                                    ...
                                    columns: [
                                        ...
                                        {data: 1, name: 'name_en'},
                                        {data: 2, name: 'icon', orderable: false, searchable: false, class: 'text-center'},
                                        {data: 3, name: 'status', orderable: false, searchable: false, class: 'text-center'},
