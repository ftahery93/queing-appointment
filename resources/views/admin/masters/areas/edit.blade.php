...
Areas
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"   action="{{ url('/admin/areas/'. $Area->id)  }}" method="POST" id="form1">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('name_en') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name_en" autocomplete="off" value="{{ $Area->name_en }}" name="name_en">
                            ...
                            <div class="col-sm-6{{ $errors->has('name_ar') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name_ar" autocomplete="off" value="{{ $Area->name_ar }}" name="name_ar"> 
                            ...
                            <div class="col-sm-6{{ $errors->has('governorate_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <select name="governorate_id" class="select2" data-allow-clear="true" >
                                        ...
                                        <option value="{{ $governorate->gid }}" @if($Area->governorate_id == $governorate->gid) selected  @endif >{{ $governorate->name_en }}</option>
                                        @endforeach
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-9">
                                    <select name="status" class="select2" data-allow-clear="true" id="status" >
                                        <option value="1" @if($Area->status == 1) selected  @endif > Active</option>
                                        <option value="0" @if($Area->status == 0) selected  @endif > Deactive</option>
                                    </select>
                                </div>
                            </div>
