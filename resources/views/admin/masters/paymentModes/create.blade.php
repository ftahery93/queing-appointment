...
<li>
    ...
    <a href="{{ url('admin/paymentModes') }}">Payment Mode</a>
</li>
@endsection
...
Payment Mode
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"  method="POST" action="{{ url('/admin/paymentModes') }}" id="form1">
    {{ method_field('POST') }}
    {{ csrf_field() }}
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options padding10">
                        ...
                        <a href="{{ url('admin/paymentModes') }}" class="margin-top0">
