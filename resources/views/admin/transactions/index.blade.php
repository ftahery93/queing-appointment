...
Transactions
@endsection
<form class="form" role="form" method="POST" action="{{ url('admin/transactions/delete')  }}" >  
    {{ csrf_field() }} 
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        @if ($CreateAccess==1)
                        <a href="{{ url('admin/transactions/create')  }}" class="margin-top0">
                    ...
                    <table class="table table-bordered datatable" id="table-4">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center col-sm-1">Transferred Date</th>
                            ...
                            jQuery(document).ready(function ($) {
                                ...
                                $table4.DataTable({
                                    ...
                                    columns: [
                                        ...
                                        {data: 1, name: 'name'},
                                        {data: 2, name: 'user_type', orderable: false, searchable: false, class: 'text-center'},
                                        {data: 3, name: 'total_amount', orderable: false, searchable: false, class: 'text-center'},
                                        {data: 4, name: 'transferred_amount', orderable: false, searchable: false, class: 'text-center'},
                                        {data: 5, name: 'due_amount', orderable: false, searchable: false, class: 'text-center'},
                                        {data: 6, name: 'transferred_date', class: 'text-center'},
...
// Removed the checked state from "All" if any checkbox is unchecked
                                        ...
                                        $('.transactionEmail').on('click', function (e) {
                                            ...
                                            $.ajax({
                                                type: "GET",
                                                async: true,
                                                url: "{{ url('admin/transactions')}}/"+ID + '/transactionEmail',
                                                data: {id: ID},
                                                success: function (data) {
                                                    $table4.DataTable().ajax.reload(null, false);
                                                    toastr.success(data.response, "", opts);
