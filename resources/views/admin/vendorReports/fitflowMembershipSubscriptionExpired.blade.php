                                   ...
                                   // $('#daterange, #start_date, #end_date').val('');
                                    ...
                                    $table4.DataTable({
                                       "bStateSave": true,
                                        ...
                                        "ajax": {
                                            "type": "GET",
                                            "url": '{{ url("admin/fitflowMembershipSubscriptionExpired") }}',
                                            data: function (data) {
...
<script>
    ...
    function ConfirmPrint() {
        window.location.href = '{{ url("admin/printfitflowMembershipSubscriptionExpired") }}';
    }

    /*------END----*/

    function excelExport() {
        window.location.href = '{{ url("admin/excelfitflowMembershipSubscriptionExpired") }}';
    }
</script> 
@endsection