...
<script type="text/javascript">
                                jQuery(document).ready(function ($) {
                                    ...
                                    $table4.DataTable({
                                        ...
                                        "ajax": {
                                            "type": "GET",
                                            "url": '{{ url("admin/fitflowMembershipBookings") }}',
                                            data: function (data) {
                                        ...
                                        columns: [
                                            {data: 0, name: 'name'},
                                            {data: 1, name: 'vendor_name'},
                                            {data: 2, name: 'class_name'},
                                            {data: 3, name: 'start', class: 'text-center', orderable: false},
                                            {data: 4, name: 'end', class: 'text-center', orderable: false},
                                            {data: 5, name: 'schedule_date', class: 'text-center'},
                                            {data: 6, name: 'created_at', class: 'text-center', orderable: false},
                                        ],
                                        order: [[6, 'desc']],
...
<script>
    ...
    function ConfirmPrint() {
        ...
        window.location.href = '{{ url("admin/printfitflowMembershipBookings") }}';
//        } else {
//            return false;
//        }
    }
    ...
    function excelExport() {
        window.location.href = '{{ url("admin/excelfitflowMembershipBookings") }}';
    }
</script> 
<script>
    $(function () {
