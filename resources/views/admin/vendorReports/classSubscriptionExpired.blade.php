...
<script type="text/javascript">
                                jQuery(document).ready(function ($) {
                                    ...
                                    $table4.DataTable({
                                        ...
                                        "ajax": {
                                            "type": "GET",
                                            "url": '{{ url("admin/classSubscriptionExpired") }}',
                                            data: function (data) {
...
<script>
    ...
    function ConfirmPrint() {
        window.location.href = '{{ url("admin/printClassSubscriptionExpired") }}';
    }

    /*------END----*/

    function excelExport() {
        window.location.href = '{{ url("admin/excelClassSubscriptionExpired") }}';
    }
</script> 
@endsection