                                ...
                                jQuery(document).ready(function ($) {
                                    ...
                                    $table4.DataTable({
                                       "bStateSave": true,
                                        ...
                                        "ajax": {
                                            "type": "GET",
                                            "url": '{{ url("admin/vendorSubscriptions") }}',
                                            data: function (data) {
                                        ...
                                        columns: [
                                            {data: 0, name: 'name'},
                                            {data: 1, name: 'email', orderable: false},
                                            {data: 2, name: 'mobile', class: 'text-center', orderable: false},
                                            {data: 3, name: 'gender_name', class: 'text-center', orderable: false},
                                            {data: 4, name: 'package_name', class: 'text-center', orderable: false},
...
<script>
    ...
    function ConfirmPrint() {
        window.location.href = '{{ url("admin/printVendorSubscriptions") }}';
    }

    /*------END----*/

    function excelExport() {
        window.location.href = '{{ url("admin/excelVendorSubscriptions") }}';
    }
</script> 
@endsection