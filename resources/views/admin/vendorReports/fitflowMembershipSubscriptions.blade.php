    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default" data-collapsed="0">   
            <ul class="nav nav-tabs bordered"><!-- available classes "bordered", "right-aligned" -->
                ...
                <li class="{{ active('admin/vendorSubscriptions') }}">
                 ...
                 @endif
                 @if (Auth::user()->hasRolePermission('classSubscriptions'))
                <li class="{{ active('admin/classSubscriptions') }}">
                ...
                @endif
                 @if (Auth::user()->hasRolePermission('fitflowMembershipSubscriptions'))
                <li class="{{ active('admin/fitflowMembershipSubscriptions') }}">
                ...
                @endif
                 @if (Auth::user()->hasRolePermission('estoreSubscriptions'))
                 <li class="{{ active('admin/estoreSubscriptions') }}">
                    <a href="{{ url('admin/estoreSubscriptions')  }}" >
                        <span class="visible-xs"><i class="entypo-user"></i></span>
                                ...
                                jQuery(document).ready(function ($) {
                                    ...
                                    $table4.DataTable({
                                       "bStateSave": true,
                                        ...
                                        "ajax": {
                                            "type": "GET",
                                            "url": '{{ url("admin/fitflowMembershipSubscriptions") }}',
                                            data: function (data) {
                                        ...
                                        columns: [
                                            ...
                                            {data: 3, name: 'gender', class: 'text-center', orderable: false},
                                            {data: 4, name: 'name_en', class: 'text-center'},
                                            {data: 5, name: 'num_points', class: 'text-center', orderable: false},
                                            {data: 6, name: 'num_booked', class: 'text-center', orderable: false},
                                            {data: 8, name: 'period', class: 'text-center', orderable: false, searchable: false},
                                        ],
                                        order: [[7, 'desc']],
...
<script>
    ...
    function ConfirmPrint() {
        window.location.href = '{{ url("admin/printfitflowMembershipSubscriptions") }}';
    }

    /*------END----*/

    function excelExport() {
        window.location.href = '{{ url("admin/excelfitflowMembershipSubscriptions") }}';
    }
</script> 
@endsection