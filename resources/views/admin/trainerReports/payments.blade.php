                                       ...
                                       "bStateSave": true,
                                        ...
                                        columns: [
                                           {data: 0, name: 'trainer'},
                                            ...
                                            {data: 3, name: 'reference_id',orderable: false, searchable: false, class: 'text-center'},
                                             {data: 4, name: 'amount', class: 'text-right'},
                                            {data: 5, name: 'post_date', class: 'text-center'},
                                            {data: 6, name: 'payment_method', class: 'text-right'},
                                        ],
                                        order: [[5, 'desc']],
...
<script>
    ...
    function ConfirmPrint() {
        window.location.href = '{{ url("admin/printTrainerPayments") }}';
    }

    /*------END----*/

    function excelExport() {
        window.location.href = '{{ url("admin/excelTrainerPayments") }}';
    }
</script> 
@endsection