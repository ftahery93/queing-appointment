...
Trainer Notifications
@endsection
<form class="form" role="form" method="POST" action="{{ url('admin/trainerNotifications/delete')  }}" >  
    {{ csrf_field() }} 
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        @if ($CreateAccess==1)
                        <a href="{{ url('admin/trainerNotifications/create')  }}" class="margin-top0">
...
<script type="text/javascript">
                           jQuery(document).ready(function ($) {
                               ...
                               $table4.DataTable({
                                   ...
                                   "ajax": {
                                       "type": "GET",
                                       "url": '{{ url("admin/trainerNotifications") }}',
                                       complete: function () {
                                           $('.loading-image').hide();
                                       }
                                   },
