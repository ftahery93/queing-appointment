...
Trainer Notifications
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"   action="{{ url('/admin/trainerNotifications/'. $Notification->id)  }}" method="POST" id="form1" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-6{{ $errors->has('trainer_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <select name="trainer_id" class="select2" data-allow-clear="true" id="trainer_id" onchange="GetSelectedTextValue()" >
                                        ...
                                        <option value="{{ $Trainer->id }}"  @if($Notification->trainer_id==$Trainer->id) selected  @endif> {{ $Trainer->name }}</option>
                                        @endforeach
                                    </select>
