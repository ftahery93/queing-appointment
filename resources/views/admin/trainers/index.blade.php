...
Trainers
@endsection
<form class="form" role="form" method="POST" action="{{ url('admin/trainers/delete')  }}" >  
    {{ csrf_field() }} 
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        @if ($CreateAccess==1)
                        <a href="{{ url('admin/trainers/create')  }}" class="margin-top0">
                       ...
                       <button Onclick="return ConfirmDelete();" type="button" class="btn btn-danger btn-icon">
                        ...
                        <a href="{{ url('admin/trainers/trashedlist')  }}" class="margin-top0">
...
// Removed the checked state from "All" if any checkbox is unchecked
                                        ...
                                        $('.sendCredential').on('click', function (e) {
                                            ...
                                            $.ajax({
                                                type: "GET",
                                                async: true,
                                                url: "{{ url('admin/trainers')}}/"+ID + '/sendCredential',
                                                data: {id: ID},
                                                success: function (data) {
                                                    $table4.DataTable().ajax.reload(null, false);
                                                    toastr.success(data.response, "", opts);
