...
Coupons
@endsection
<form class="form" role="form" method="POST" action="{{ url('admin/coupons/delete')  }}" >  
    {{ csrf_field() }} 
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        @if ($CreateAccess==1)
                        <a href="{{ url('admin/coupons/create')  }}" class="margin-top0">
                    ...
                    <table class="table table-bordered datatable" id="table-4">
                        <thead>
                            <tr>
                                ...
                                <th class="col-sm-2">Date Start</th>
                                <th class="col-sm-2">Date End</th>
...
<script type="text/javascript">
                           ...
                           dom: 'lBfrtip',
                                   ...
                                   {data: 1, name: 'name_en'},
                                   {data: 2, name: 'code', orderable: false},
                                   {data: 3, name: 'discount', class: 'text-right'},
                                   {data: 4, name: 'start_date', class: 'text-center', orderable: false, searchable: false},
                                   {data: 5, name: 'end_date', class: 'text-center', orderable: false, searchable: false},
                                   {data: 6, name: 'status', class: 'text-center', orderable: false, searchable: false},
