...
Coupons
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"  method="POST" action="{{ url('/admin/coupons/'. $Coupon->id) }}" id="form1" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-6{{ $errors->has('vendor_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <select name="vendor_id" class="select2" data-allow-clear="true">
                                        ...
                                        <option value="0" @if($Coupon->vendor_id==0) selected @endif>--All Vendors--</option>
                                        @foreach ($vendors as $vendor)
                                        <option value="{{ $vendor->id }}" @if($Coupon->vendor_id==$vendor->id) selected @endif >{{ $vendor->name }}</option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('name_en') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name_en" autocomplete="off" value="{{ $Coupon->name_en }}" name="name_en">
                            ...
                            <div class="col-sm-6{{ $errors->has('name_ar') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name_ar" autocomplete="off" value="{{ $Coupon->name_ar }}" name="name_ar" dir="rtl">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('type') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <select name="type" class="select2" data-allow-clear="true" >           
                                        ...
                                        <option value="2"  @if($Coupon->type == 2) selected  @endif >Fixed Amount</option>                          
                                    </select>
                                    @if ($errors->has('type'))
                                    <span class="help-block">
                            ...
                            <div class="col-sm-6{{ $errors->has('discount') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="form-control" id="discount" autocomplete="off"  name="discount" value="{{ $Coupon->discount }}"> 
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <div class="col-sm-6{{ $errors->has('code') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="code" autocomplete="off" value="{{ $Coupon->code }}" name="code">
                                    @if ($errors->has('code'))
                                    <span class="help-block">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('start_date') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control datetimepicker" id="start_date" autocomplete="off"  value="{{ $Coupon->start_date }}" name="start_date">
                            ...
                            <div class="col-sm-6{{ $errors->has('end_date') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control datetimepicker" id="end_date" autocomplete="off"  value="{{ $Coupon->end_date }}" name="end_date">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <div class="col-sm-6{{ $errors->has('uses_total') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control number_only" id="uses_total" autocomplete="off" value="{{ $Coupon->uses_total }}" name="uses_total">
                            ...
                            <div class="col-sm-6{{ $errors->has('uses_customer') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control number_only" id="uses_customer" autocomplete="off" value="{{ $Coupon->uses_customer }}" name="uses_customer">
