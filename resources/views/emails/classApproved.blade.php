...
<html>
    ...
    <head>
        ...
        <style type="text/css" rel="stylesheet" media="all">
            ...
            table.inner_table tr td{border:1px solid #dadada;padding:5px;}
            table.inner_table tr th{padding:5px;}
        </style>
    </head>
                                                    ...
                                                    <td align="center">
                                                        <div id="rec-wrapper-inv">
                                                            ...
                                                            <div class="titleblock">                              
                                                                ...
                                                                <div class="pull-right"><h3>Classes Status</h3></div>  
                                                            </div>



                                                            <div class="row-fluid" style="margin-top:10px;">     
                                                                <table class="table inner_table" style="border:1px solid #dadada;border-collapse:collapse;">
                                                                    <thead>
                                                                    <th colspan="3" style="text-align:left;">Class Name</th>
                                                                    <th>Status</th>
                                                                    <th>Reason</th>
                                                                    </thead>   
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="3"  style="text-align:left;">{{ $Class->name_en }}</td>      
                                                                            <td> @if($Class->approved_status==1) Approved @else Rejected @endif </td>
                                                                            <td> {{ $Class->reason }}</td> 
                                                                        </tr>
