...
Users Group
@endsection
<form class="form" role="form" method="POST" action="{{ url($configName.'/permissions/delete')  }}" >  
    {{ csrf_field() }} 
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        @if ($CreateAccess==1)
                        <a href="{{ url($configName.'/permissions/create')  }}" class="margin-top0">
...
<script type="text/javascript">
                            jQuery(document).ready(function ($) {
                                ...
                                $table4.DataTable({
                                    ...
                                    "ajax": {
                                        "type": "GET",
                                        "url": '{{ url("$configName/permissions") }}',
                                        complete: function () {
                                            $('.loading-image').hide();
                                        }
                                    },
...
// Removed the checked state from "All" if any checkbox is unchecked
                                        ...
                                        $('.status').on('click', function (e) {
                                            ...
                                            $.ajax({
                                                type: "PATCH",
                                                async: true,
                                                "url": '{{ url("$configName/permissions") }}/'+ID,
