...
Branches
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"   action="{{ url($configName.'/vendorBranches/'. $VendorBranch->id)  }}" method="POST" id="form1" enctype="multipart/form-data" name="form1">
