            ...
            <div class="row margin10">
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-6 pull-right">
                        <button type="button" class="btn btn-info btn-xs pull-right" style="font-size:15px;">Subscribers: {{ $Count }} </button>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
                                jQuery(document).ready(function ($) {
                                    ...
                                    $table4.DataTable({
                                        ...
                                        "ajax": {
                                            "type": "GET",
                                            "url": '{{ url("$configM2/report/subscriptionExpired") }}',
                                            data: function (data) {
...
<script>
    ...
    function ConfirmPrint() {
        window.location.href = '{{ url("$configM2/reportPrint/subscriptionExpired") }}';
    }

    /*------END----*/

    function excelExport() {
        window.location.href = '{{ url("$configM2/excelModule2SubscriptionExpired") }}';
    }
</script> 
@endsection