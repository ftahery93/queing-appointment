        ...
        <div class="panel panel-dark" data-collapsed="0">   
            <div class="row margin10">
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <label for="member" class="col-sm-4 control-label">Subscriber</label>
            ...
            <div class="row margin10">
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-6 pull-right">
                        <button type="button" class="btn btn-info btn-xs pull-right" style="font-size:15px;">Subscribers: <span id="count" >{{ $Count }}</span> </button>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
                                jQuery(document).ready(function ($) {
                                    ...
                                    $table4.DataTable({
                                        ...
                                        "ajax": {
                                            "type": "GET",
                                            "url": '{{ url("$configM2/report/subscriptions") }}',
                                            data: function (data) {
                                        ...
                                        columns: [
                                            {data: 0, name: 'name'},
                                            {data: 1, name: 'email', class: 'text-center', orderable: false, orderable: false},
...
<script>
    ...
    function ConfirmPrint() {
        window.location.href = '{{ url("$configM2/reportPrint/subscriptions") }}';
    }

    /*------END----*/

    function excelExport() {
        window.location.href = '{{ url("$configM2/excelModule2Subscriptions") }}';
    }
</script> 
@endsection