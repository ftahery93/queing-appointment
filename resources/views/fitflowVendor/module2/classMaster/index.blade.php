...
Classes
@endsection
<form class="form" role="form" method="POST" action="{{ url($configM2.'/classMaster/delete')  }}" >  
    {{ csrf_field() }} 
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        @if ($CreateAccess==1)
                        <a href="{{ url($configM2.'/classMaster/create')  }}" class="margin-top0">
...
// Removed the checked state from "All" if any checkbox is unchecked
                                    ...
                                    type: "PATCH",
                                            async: true,
                                            "url": '{{ url("$configM2/classMaster") }}/' + ID,
