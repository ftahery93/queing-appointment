...
Branch wise Class - {{  $className }}
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"   action="{{ url($configM2.'/'.$classMasterID.'/classes/'. $Classes->id)  }}" method="POST" id="form1" enctype="multipart/form-data" name="form1">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('gender_type') ? ' has-error' : '' }}">
                                <label for="gender_type" class="col-sm-3 control-label">Gender</label>
                                <div class="col-sm-9">
                                    <select name="gender_type" class="select2" data-allow-clear="true"   id="gender">

                                        @foreach ($gender_types as $gender_type)
                                        <option value="{{ $gender_type->id }}" @if ($Classes->gender_type==$gender_type->id) selected  @endif >{{ $gender_type->name_en }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-6{{ $errors->has('branch_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <select name="branch_id" class="select2" data-allow-clear="true">
                                        ...
                                        <option value="{{ $branch->id }}" @if ($Classes->branch_id==$branch->id) selected  @endif >{{ $branch->name_en }}</option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <!--                            <div class="col-sm-6{{ $errors->has('price') ? ' has-error' : '' }}">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="tel" class="form-control" id="price" autocomplete="off"  name="price" value="{{ $Classes->price }}" readonly="readonly"> 
                                                                @if ($errors->has('price'))
                                                                <span class="help-block">
                            ...
                            <div class="col-sm-6{{ $errors->has('trainer_name_en') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="trainer_name_en" autocomplete="off" value="{{ $Classes->trainer_name_en }}" name="trainer_name_en">
                            ...
                            <div class="col-sm-6{{ $errors->has('num_seats') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="form-control" id="num_seats" autocomplete="off"  value="{{ $Classes->num_seats }}" name="num_seats" >
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('fitflow_seats') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="form-control" id="fitflow_seats" autocomplete="off"  name="fitflow_seats" value="{{ $Classes->fitflow_seats }}" > 
                            ...
                            <div class="col-sm-6{{ $errors->has('available_seats') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="form-control" id="available_seats" autocomplete="off"  value="{{ $Classes->available_seats }}" name="available_seats" readonly="readonly" >
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <div class="col-sm-6{{ $errors->has('hours') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="form-control number_only" id="hours" autocomplete="off"  value="{{ $Classes->hours }}" name="hours">
                                    @if ($errors->has('hours'))
                                    <span class="help-block">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-9">
                                    <select name="status" class="select2" data-allow-clear="true" id="status" >
                                        <option value="1" @if($Classes->status == 1) selected  @endif> Active</option>
                                        <option value="0" @if($Classes->status == 0) selected  @endif> Deactive</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <div class="col-sm-6{{ $errors->has('description_en') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <textarea  class="form-control resize" name="description_en" id="description_en" >{{ $Classes->description_en }}</textarea>
                            ...
                            <div class="col-sm-6{{ $errors->has('description_ar') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <textarea  class="form-control resize" name="description_ar" id="description_ar" dir="rtl" >{{ $Classes->description_ar }}</textarea>
