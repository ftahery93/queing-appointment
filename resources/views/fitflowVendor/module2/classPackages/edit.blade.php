...
<li>
    ...
    <a href="{{ url($configM2.'/classPackages') }}">Class Packages</a>
</li>
@endsection
...
Class Packages
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"   action="{{ url($configM2.'/classPackages/'. $ClassPackage->id)  }}" method="POST" id="form1" enctype="multipart/form-data">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options padding10">
                        ...
                        <a href="{{ url($configM2.'/classPackages') }}" class="margin-top0">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('name_en') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name_en" autocomplete="off" value="{{ $ClassPackage->name_en }}" name="name_en">
                            ...
                            <div class="col-sm-6{{ $errors->has('name_ar') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name_ar" autocomplete="off" value="{{ $ClassPackage->name_ar }}" name="name_ar">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('price') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="form-control" id="price" autocomplete="off"  name="price" value="{{ $ClassPackage->price }}"> 
                                    @if ($errors->has('price'))
                                    <span class="help-block">
                              ...
                              <div class="col-sm-6{{ $errors->has('num_days') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="form-control" id="num_days" autocomplete="off"  value="{{ $ClassPackage->num_days }}" name="num_days">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                             ...
                             <div class="col-sm-6{{ $errors->has('expired_notify_duration') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="form-control" id="expired_notify_duration" autocomplete="off"  value="{{ $ClassPackage->expired_notify_duration }}" name="expired_notify_duration">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-9">
                                    <select name="status" class="select2" data-allow-clear="true" id="status" >
                                        <option value="1" @if($ClassPackage->status == 1) selected  @endif> Active</option>
                                        <option value="0" @if($ClassPackage->status == 0) selected  @endif> Deactive</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <div class="col-sm-6{{ $errors->has('description_en') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <textarea  class="form-control resize" name="description_en" id="description_en" >{{ $ClassPackage->description_en }}</textarea>
                            ...
                            <div class="col-sm-6{{ $errors->has('description_ar') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <textarea  class="form-control resize" name="description_ar" id="description_ar" >{{ $ClassPackage->description_ar }}</textarea>
                     ...
                     <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('num_points') ? ' has-error' : '' }}"  id="num_class">
                                ...
                                <div class="col-sm-5">
                                    <input @if($ClassPackage->num_points == 0) type="hidden" else type="tel"  @endif class="form-control" id="num_points" autocomplete="off"  name="num_points" value="{{ $ClassPackage->num_points }}" >
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input tabindex="5" type="checkbox" class="icheck-14 col-sm-4" id="minimal-checkbox-1-14"  @if($ClassPackage->num_points == 0) checked  @endif>
                                           <label for="minimal-checkbox-1-14" class="col-sm-8 control-label">Unlimited</label>
                            ...
                            <div class="col-sm-6">
                                   ...
                                   <div class="col-sm-9">
                                    <input tabindex="5" type="checkbox" class="icheck-14 col-sm-4" id="offer" 
                                     @if($ClassPackage->has_offer == 1) checked  @endif>
                                     <input type="hidden" name="has_offer" id="has_offer"  value="{{ $ClassPackage->has_offer }}" >
                                </div>
                                </div>
                            <?php /* ?>
                            <div class="col-sm-6{{ $errors->has('branch_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <select name="branch_id" class="select2" data-allow-clear="true">
                                        ...
                                        <option value="{{ $branch->id }}" @if ($ClassPackage->branch_id==$branch->id) selected  @endif >{{ $branch->name_en }}</option>
                                        @endforeach
                                    </select>
