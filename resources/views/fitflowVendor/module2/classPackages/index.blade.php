...
Class Packages
@endsection
<form class="form" role="form" method="POST" action="{{ url($configM2.'/classPackages/delete')  }}" >  
    {{ csrf_field() }} 
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        @if ($CreateAccess==1)
                        <a href="{{ url($configM2.'/classPackages/create')  }}" class="margin-top0">
...
<!--                                <th class="col-sm-2">Branch Name</th>-->
                                <th class="col-sm-6">Package Name</th>
                                <th class="col-sm-2">No. Classes</th>
                                <th class="col-sm-2">No. of Days</th>
                                <th class="col-sm-2">Price</th>
                                <th class="text-center">Status</th>
                                <th class="text-center col-sm-3">Created On</th>
...
<script type="text/javascript">
                            ...
                            dom: 'lBfrtip',
                                    ...
                                    "ajax": {
                                    "type": "GET",
                                            "url":  '{{ url("$configM2/classPackages") }}',
                                            complete: function () {
                                            $('.loading-image').hide();
                                            }
                                    },
...
// Removed the checked state from "All" if any checkbox is unchecked
                                    ...
                                    type: "PATCH",
                                            async: true,
                                            "url": '{{ url("$configM2/classPackages") }}/' + ID,
