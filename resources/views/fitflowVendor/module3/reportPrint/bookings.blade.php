...
<li>
    ...
    <a href="{{ url($configM3.'/m3/report/bookings') }}">Bookings</a>
</li>
@endsection

@section('pageheading')
Bookings - Print Preview
@endsection
                ...
                <table class="table table-bordered datatable" id="table-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th class="col-sm-2 text-center">{{ Carbon\Carbon::parse($booking->start)->format('h:i:A') }}</th>
                            <th class="col-sm-2 text-center">{{ Carbon\Carbon::parse($booking->end)->format('h:i:A') }}</th>                            
