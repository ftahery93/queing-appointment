                    ...
                    <div class="tab-pane active" id="active">
                        ...
                        <div class="panel-body  table-responsive">
                            ...
                            <table class="table table-bordered datatable" id="table-4">
                                <thead>
                                    <tr>
                                        <th class="col-sm-5">Subscriber</th>
...
<script type="text/javascript">
                    jQuery(document).ready(function ($) {
                        ...
                        $table4.DataTable({
                            ...
                            "ajax": {
                                "type": "GET",
                                "url": '{{ url("$configM3/m3/subscribers") }}',
                                 data: function (data) {
                                    data.id = $('#log').val();
                                },
                                complete: function () {
                            ...
                            "fnDrawCallback": function (oSettings) {
                                ...
                                $('.current_package').on('click', function (e) {
                                    ...
                                    $.ajax({
                                        type: "GET",
                                        async: true,
                                        "url": '{{ url("$configM3/m3/subscribers") }}/'+ID + '/currentPackage',
                                ...
                                $('.current_bookings').on('click', function (e) {
                                    ...
                                    $.ajax({
                                        type: "GET",
                                        async: true,
                                        "url": '{{ url("$configM3/m3/subscribers") }}/'+ID + '/currentBooking',
                                        success: function (data) {
                                            $('#current_package').html(data.html);
                                        },
                                        complete: function () {
                                ...
                                $('.payment_details').on('click', function (e) {
                                    ...
                                    $.ajax({
                                        type: "GET",
                                        async: true,
                                        "url": '{{ url("$configM3/m3/subscribers") }}/'+ID + '/paymentDetails',
                                        success: function (data) {
                                            $('#current_package').html(data.html);
                                        },
                                        complete: function () {
