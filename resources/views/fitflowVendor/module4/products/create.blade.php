                                                ...
                                                <select name="category_id[]" class="select2" data-allow-clear="true" id="category_id" multiple="multiple" >
                                                   <option value="">-- Select Category --</option>
                                                    ...
                                                    <optgroup label="{{ ucfirst($subCate->name_en) }}">
                                                        ...
                                                        <option value="{{ $firstNestedSub->id }}" {{ (collect(old('category_id'))->contains($firstNestedSub->id)) ? 'selected':''}}> &nbsp;&nbsp;{{ ucfirst($firstNestedSub->name_en) }}</option>
                                                        @endforeach()
                                                    </optgroup>
                                                    @else     
                                                    <option value="{{ $subCate->id }}" {{ (collect(old('category_id'))->contains($subCate->id)) ? 'selected':'' }}> {{ ucfirst($subCate->name_en) }}</option>
                                                     @endif
                                                    @endforeach()
                                                </select>
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-sm-6{{ $errors->has('price') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="price number_only" autocomplete="off" value="{{ old('price') }}" name="price">
                                                @if ($errors->has('price'))
                                                <span class="help-block">
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <div class="col-sm-6{{ $errors->has('model') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="model number_only" autocomplete="off" value="{{ old('model') }}" name="model">
                                                @if ($errors->has('model'))
                                                <span class="help-block">
                                        ...
                                        <div class="hide col-sm-6{{ $errors->has('location') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="location" autocomplete="off" value="{{ old('location') }}" name="location"> 
