...
Products
@endsection
<form class="form" role="form" method="POST" action="{{ url($configM4.'/products/delete')  }}" >  
    {{ csrf_field() }} 
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        @if ($CreateAccess==1)
                        <a href="{{ url($configM4.'/products/create')  }}" class="margin-top0">
                    ...
                    <table class="table table-bordered datatable" id="table-4">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center col-sm-1">Model</th>
                                <th class="text-right col-sm-1">Price</th>
                                <th class="text-right col-sm-1">Quantity</th>
...
<script type="text/javascript">
                            ...
                            dom: 'lBfrtip',
                                    ...
                                    {data: 2, name: 'name_en'},
                                    {data: 3, name: 'model'},
                                    {data: 4, name: 'price', class: 'text-right'},
                                    {data: 5, name: 'quantity', class: 'text-right'},
                                    {data: 6, name: 'status', orderable: false, searchable: false, class: 'text-center'},
