...
Categories
@endsection
<form class="form" role="form" method="POST" action="{{ url($configM4.'/categories/delete')  }}" >  
    {{ csrf_field() }} 
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        @if ($CreateAccess==1)
                        <a href="{{ url($configM4.'/categories/create')  }}" class="margin-top0">
                    ...
                    <table class="table table-bordered datatable" id="table-4">
                        <thead>
                              <tr>
                                ...
                                <th class="col-sm-2">Parent Category</th>
...
// Removed the checked state from "All" if any checkbox is unchecked
                                    ...
                                    type: "PATCH",
                                            async: true,
                                            "url": '{{ url("$configM4/categories") }}/' + ID,
