...
Options
@endsection
<form class="form" role="form" method="POST" action="{{ url($configM4.'/options/delete')  }}" >  
    {{ csrf_field() }} 
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        @if ($CreateAccess==1)
                        <a href="{{ url($configM4.'/options/create')  }}" class="margin-top0">
                    ...
                    <table class="table table-bordered datatable" id="table-4">
                        <thead>
                              <tr>
                                ...
                                <th class="text-center col-sm-2">Sort Order</th>
...
<script type="text/javascript">
                            ...
                            dom: 'lBfrtip',
                                    ...
                                    {data: 1, name: 'name_en'},
                                    {data: 2, name: 'sort_order', orderable: false, searchable: false, class: 'text-center'},
