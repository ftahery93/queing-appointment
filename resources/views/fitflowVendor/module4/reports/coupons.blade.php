...
<script type="text/javascript">
                                jQuery(document).ready(function ($) {
                                    ...
                                    $table4.DataTable({
                                        ...
                                        "ajax": {
                                            "type": "GET",
                                            "url": '{{ url("$configM4/report/coupons") }}',
                                            complete: function () {
                                                $('.loading-image').hide();
                                            }
                                        },
                                        columns: [
                                            ...
                                            {data: 1, name: 'code', class: 'text-center', orderable: false},
                                            {data: 2, name: 'num_orders', class: 'text-center', orderable: false, searchable: false},
...
<script>
    ...
    function ConfirmPrint() {
        window.location.href = '{{ url("$configM4/reportPrint/coupons") }}';
    }

    /*------END----*/

    function excelExport() {
        window.location.href = '{{ url("$configM4/excelModule4Coupons") }}';
    }
</script> 
@endsection