...
Instructor Packages
@endsection
<form class="form" role="form" method="POST" action="{{ url($configM1.'/instructorPackages/delete')  }}" >  
    {{ csrf_field() }} 
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        @if ($CreateAccess==1)
                        <a href="{{ url($configM1.'/instructorPackages/create')  }}" class="margin-top0">
...
<script type="text/javascript">
                            ...
                            dom: 'lBfrtip',
                                    ...
                                    "ajax": {
                                    "type": "GET",
                                            "url":  '{{ url("$configM1/instructorPackages") }}',
                                            complete: function () {
                                            $('.loading-image').hide();
                                            }
                                    },
...
// Removed the checked state from "All" if any checkbox is unchecked
                                    ...
                                    type: "PATCH",
                                            async: true,
                                            "url": '{{ url("$configM1/instructorPackages") }}/' + ID,
