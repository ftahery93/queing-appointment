...
<li>
    ...
    <a href="{{ url($configM1.'/instructorPackages') }}">Instructor Packages</a>
</li>
@endsection
...
Instructor Packages
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"   action="{{ url($configM1.'/instructorPackages/'. $InstructorPackages->id)  }}" method="POST" id="form1" enctype="multipart/form-data">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options padding10">
                        ...
                        <a href="{{ url($configM1.'/instructorPackages') }}" class="margin-top0">
                ...
                <div class="panel-body">
                        ...
                        <div class="form-group col-sm-12">
                            <div class="col-sm-6{{ $errors->has('branch_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <select name="branch_id" class="select2" data-allow-clear="true">
                                        ...
                                        <option value="{{ $branch->id }}" @if ($InstructorPackages->branch_id==$branch->id) selected  @endif >{{ $branch->name_en }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-6{{ $errors->has('num_points') ? ' has-error' : '' }}"  id="num_class">
                                ...
                                <label for="num_points" class="col-sm-3 control-label">No. of Sessions</label>

                                <div class="col-sm-9">
                                    <input  type="tel"  class="form-control" id="num_points" autocomplete="off"  name="num_points"  value="{{ $InstructorPackages->num_points }}">
                            ...
                            <div class="col-sm-6 hide">
                                   ...
                                   <div class="col-sm-9">
                                    <input tabindex="5" type="checkbox" class="icheck-14 col-sm-4" id="offer" 
                                     @if($InstructorPackages->has_offer == 1) checked  @endif>
                                     <input type="hidden" name="has_offer" id="has_offer"  value="{{ $InstructorPackages->has_offer }}" >
                                </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('name_en') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name_en" autocomplete="off" value="{{ $InstructorPackages->name_en }}" name="name_en">
                            ...
                            <div class="col-sm-6{{ $errors->has('name_ar') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name_ar" autocomplete="off" value="{{ $InstructorPackages->name_ar }}" name="name_ar">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('price') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="form-control" id="price" autocomplete="off"  name="price" value="{{ $InstructorPackages->price }}"> 
                                    @if ($errors->has('price'))
                                    <span class="help-block">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-9">
                                    <select name="status" class="select2" data-allow-clear="true" id="status" >
                                        <option value="1" @if($InstructorPackages->status == 1) selected  @endif> Active</option>
                                        <option value="0" @if($InstructorPackages->status == 0) selected  @endif> Deactive</option>
                                    </select>
                                </div>
                            </div>
                              <div class="hide col-sm-6{{ $errors->has('num_days') ? ' has-error' : '' }}">
                                <label for="num_days" class="col-sm-3 control-label">No. of Days</label>

                                <div class="col-sm-9">
                                    <input type="tel" class="form-control" id="num_days" autocomplete="off"  value="{{ $InstructorPackages->num_days }}"  name="num_days">
                    ...
                    <div class="row hide">
                        <div class="form-group col-sm-12">
                             ...
                             <div class="col-sm-6{{ $errors->has('expired_notify_duration') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="form-control" id="expired_notify_duration" autocomplete="off"  value="{{ $InstructorPackages->expired_notify_duration }}" name="expired_notify_duration">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <div class="col-sm-6{{ $errors->has('description_en') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <textarea  class="form-control resize" name="description_en" id="description_en" >{{ $InstructorPackages->description_en }}</textarea>
                            ...
                            <div class="col-sm-6{{ $errors->has('description_ar') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <textarea  class="form-control resize" name="description_ar" id="description_ar" >{{ $InstructorPackages->description_ar }}</textarea>
