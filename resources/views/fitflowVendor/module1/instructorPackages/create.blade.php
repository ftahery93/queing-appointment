...
Instructor Packages
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"  method="POST" action="{{ url($configM1.'/instructorPackages') }}" id="form1" enctype="multipart/form-data">
    {{ method_field('POST') }}
    {{ csrf_field() }}
                        ...
                        <div class="form-group col-sm-12">
                           ...
                           <div class="col-sm-6 hide">
                                   ...
                                   <div class="col-sm-9">
                                    ...
                                    <input type="hidden" name="has_offer" id="has_offer" value="0" >
                                </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="hide col-sm-6{{ $errors->has('num_days') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="form-control" id="num_days" autocomplete="off"  name="num_days">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12 hide">
                            <div class="col-sm-6{{ $errors->has('expired_notify_duration') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="form-control" id="expired_notify_duration" autocomplete="off"   name="expired_notify_duration">
