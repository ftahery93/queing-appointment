...
Members
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"  method="POST" action="{{ url($configM1.'/members') }}" id="form1" enctype="multipart/form-data">
    {{ method_field('POST') }}
    {{ csrf_field() }}
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <div class="col-sm-6{{ $errors->has('package_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <select name="package_id" class="select2" data-allow-clear="true" id="package_id">
                                        ...
                                        <option value="{{ $package->id }}" {{ (collect(old('package_id'))->contains($package->id)) ? 'selected':'' }} >{{ $package->name_en }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-6{{ $errors->has('cash') ? ' has-error' : '' }}">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('knet') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9"> 
                                   ...
                                   @if ($errors->has('knet'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('knet') }}</strong>
                                    </span>
                                    @endif
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-9">
                                    <input type="end_date" class="form-control" id="end_date" autocomplete="off" disabled="disabled">                                    
                                </div>
                            </div>
                            <div class="col-sm-6">
