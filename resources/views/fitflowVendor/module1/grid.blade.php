<div class="row sales">
    ...
    <div class="col-sm-3">
        ...
        <div class="tile-progress magenta">
            ...
            <div class="tile-header">
                <h3 class="text-center">{{ number_format($totalAmount, config('global.decimalValue')) }} 
                    <span class="kd_span">{{ config('global.amountCurrency') }}</span></h3>
            </div>
    ...
    <div class="col-sm-3">
        ...
        <div class="tile-progress orange">
            ...
            <div class="tile-header">
                <h3 class="text-center">{{ number_format($totalProfit, config('global.decimalValue')) }}
                   <span class="kd_span">{{ config('global.amountCurrency') }}</span> </h3>
    ...
    <div class="col-sm-3">
        ...
        <div class="tile-progress neon">
            ...
            <div class="tile-header">
                <h3 class="text-center">{{ number_format($totalAdminCommission, config('global.decimalValue')) }} 
                   <span class="kd_span">{{ config('global.amountCurrency') }}</span> </h3>
            </div>
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th class="col-sm-1 text-center">Collected By</th>                          
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ $invoice->cash }}</td>
                            <td class="text-center">{{ $invoice->knet }}</td>
