...
<script type="text/javascript">
                                ...
                                $table4.DataTable({                                
                                        ...
                                        "ajax": {
                                        "type": "GET",
                                                "url": '{{ url("$configM1/subscriptionExpired") }}',
                                                data: function (data) {
...
<script>
    ...
    function ConfirmPrint() {
        window.location.href = '{{ url("$configM1/printsubscriptionExpired") }}';
    }

    /*------END----*/

    function excelExport() {
        window.location.href = '{{ url("$configM1/excelsubscriptionExpired") }}';
    }
</script> 
@endsection