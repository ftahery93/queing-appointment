    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-dark" data-collapsed="0">   
            <div class="row margin10">
                <div class="col-sm-12">
                    <div class="col-sm-6">
                        <label for="field-2" class="col-sm-4 control-label">Date</label>
...
<script type="text/javascript">
                            jQuery(document).ready(function ($) {
                                ...
                                $table4.DataTable({
                                    ...
                                    columns: [
                                        {data: 0, name: 'subscriber_id', orderable: false},
...
<script>
    ...
    function ConfirmPrint() {          
        //if (confirm('{{ config('global.printConfirmation') }}')) {
            window.location.href = '{{ url("$configM1/printFavourites") }}';
//        } else {
//            return false;
//        }
    }
    ...
    window.location.href = '{{ url("$configM1/excelFavourites") }}';
     }
</script> 
@endsection