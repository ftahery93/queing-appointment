        ...
        <div class="panel panel-dark" data-collapsed="0">   
            <div class="row margin10">
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <label for="log" class="col-sm-2 control-label">Member</label>
...
<script>
    ...
    function ConfirmPrint() {
        window.location.href = '{{ url("$configM1/printPayments") }}';
    }

    /*------END----*/

    function excelExport() {
        window.location.href = '{{ url("$configM1/excelPayments") }}';
    }
</script> 
@endsection