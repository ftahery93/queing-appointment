...
<div class="login-container">
    ...
    <div class="login-header">
        ...
        <div class="login-content">
            ...
            <a href="{{ url($configName) }}" class="logo">
    ...
    <div class="login-form">
        ...
        <div class="login-content">
            ...
            <form role="form"  autocomplete="off"  method="POST" action="{{ url(config('global.fitflowVendor').'/'.$code.'/login') }}" id="form1">
                {{ method_field('POST') }}
                {{ csrf_field() }}
            ...
            <div class="login-bottom-links">
                ...
                <a href="{{ url($configName.'/password/reset') }}" class="link">Forgot your password?</a>
