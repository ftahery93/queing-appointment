...
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"  method="POST" action="{{ url($configName.'/importexportdata') }}" id="form1"  enctype="multipart/form-data">
    {{ method_field('POST') }}
    {{ csrf_field() }}
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options padding10">
                        ...
                        <a href="{{ url($configName.'/importexportdata') }}" class="margin-top0">
...
//        var import_file = $('#import_file').val();
        ...
        $.ajax({
            ...
            cache: false,
            processData: false,
            "url": '{{ url("$configName/importexportdata") }}',
            ...
            success: function (data) {
                ...
                if (data.success) {
                   window.location.href='{{ url("$configM1/members") }}';
                }
            },
            complete: function () {
                $('.loading-image').hide();
