...
class classApprovedEmail extends Mailable {
    ...
    public function build() {
        ...
        $Classes = DB::table('classes')
                        ...
                        ->select(DB::raw('CONCAT(class_master.name_en, " ","-", vendor_branches.name_en) AS name_en'), 'classes.approved_status', 'classes.reason')
