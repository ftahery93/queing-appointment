        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($ImportExportData)
                            ...
                            ->editColumn('action', function ($ImportExportData) {
                                return '<a href="'.url('admin/importexportdata') .'/' . $ImportExportData->id . '" class="btn btn-primary tooltip-primary btn-small" data-toggle="tooltip" data-placement="top" title="Import Excel Data" data-original-title="Import Excel Data">'
                                        . '<i class="fa fa-cloud-upload"></i></a> '
                                        . '<a href="'.url('admin/importexportdata/excel') .'/' . $ImportExportData->id . '" class="btn btn-success tooltip-primary btn-small" data-toggle="tooltip" data-placement="top"
