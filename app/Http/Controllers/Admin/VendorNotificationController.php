...
class VendorNotificationController extends Controller {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($Notification)
                            ...
                            ->editColumn('action', function ($Notification) {
                                if ($this->EditAccess)
                                    return '<a href="'.url('admin/vendorNotifications') .'/' . $Notification->id . '/edit" class="btn btn-info tooltip-primary btn-small" data-toggle="tooltip" data-placement="top" title="Edit Records" data-original-title="Edit Records"><i class="entypo-pencil"></i></a>';
                            })
                            ->make();
        }

        return view('admin.vendorNotifications.index')
    ...
    public function create() {
        ...
        return view('admin.vendorNotifications.create')->with('Vendors', $Vendors);
    }
    ...
    public function store(Request $request) {
        ...
        if ($validator->fails()) {
            ...
            return redirect('admin/vendorNotifications/create')
            ...
            return redirect('admin/vendorNotifications');
        }
    }
    ...
    public function edit($id) {
        ...
        return View::make('admin.vendorNotifications.edit')
                        ->with('Notification', $Notification)->with('Vendors', $Vendors);
    }
    ...
    public function update(Request $request, $id) {
        ...
        if ($validator->fails()) {
            ...
            return redirect('admin/vendorNotifications/' . $id . '/edit')
                            ->withErrors($validator)->withInput();
        } else {
            $input = $request->all();
